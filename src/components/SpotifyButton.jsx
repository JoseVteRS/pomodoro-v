...
export const SpotifyButton = () => {
    return (
        <button className='bg-[#1DB954] hover:bg-white transition-all duration-150 px-4 py-2 rounded-full text-[#212121] uppercase font-bold flex items-center justify-center gap-2 text-sm tracking-wider' >
            <svg
                fill="currentColor"
                viewBox="0 0 16 16"
                height="1em"
